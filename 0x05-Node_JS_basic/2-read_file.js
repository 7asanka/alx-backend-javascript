...
/**
 * Reads and counts students from a CSV database file.
 * Logs total students and counts by field with names.
 * @param {string} path - The file path to the database CSV.
 */
